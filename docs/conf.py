...
"""
openedx-wikilearn-features documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-wikilearn-features',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/wikimedia/openedx-wikilearn-features",
...
#
# html_title = 'openedx-wikilearn-features v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Wikilearn features for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_wikilearn_features'),
                os.path.join(root_path, 'openedx_wikilearn_features/migrations')])
