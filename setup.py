#!/usr/bin/env python
"""
Package metadata for openedx_wikilearn_features.
"""
...
VERSION = get_version("openedx_wikilearn_features", "__init__.py")
...
setup(
    name="openedx-wikilearn-features",
    version=VERSION,
    description="""Wikilearn features for Open edX""",
    long_description=README + "\n\n" + CHANGELOG,
    author="Ahmed Khalid",
    author_email="ahmed.khalid@arbisoft.com",
    url="https://github.com/wikimedia/openedx-wikilearn-features",
    packages=find_packages(
        include=["openedx_wikilearn_features", "openedx_wikilearn_features.*"],
        exclude=["*tests"],
    ),
